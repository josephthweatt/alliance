...
public class AccessManagerImplTest extends NsiliCommonTestHelper {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AccessManagerImplTest.class);
