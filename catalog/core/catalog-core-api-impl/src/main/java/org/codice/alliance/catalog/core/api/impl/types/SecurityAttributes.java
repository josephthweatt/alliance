...
public class SecurityAttributes extends Security implements MetacardType {
  ...
  static {
    ...
    DESCRIPTORS.add(
        new AttributeDescriptorImpl(
            METADATA_ORIGINATOR_CLASSIFICATION,
            true /* indexed */,
            true /* stored */,
            false /* tokenized */,
            false /* multivalued */,
    ...
    DESCRIPTORS.add(
        new AttributeDescriptorImpl(
            METADATA_CLASSIFICATION_SYSTEM,
            true /* indexed */,
            true /* stored */,
            false /* tokenized */,
            false /* multivalued */,
    ...
    DESCRIPTORS.add(
        new AttributeDescriptorImpl(
            RESOURCE_ORIGINATOR_CLASSIFICATION,
            true /* indexed */,
            true /* stored */,
            false /* tokenized */,
            false /* multivalued */,
    ...
    DESCRIPTORS.add(
        new AttributeDescriptorImpl(
            RESOURCE_CLASSIFICATION_SYSTEM,
            true /* indexed */,
            true /* stored */,
            false /* tokenized */,
            false /* multivalued */,
